...
<head>
  <meta charset="utf-8">
  <title>Contacto - Rair Virtual</title>
...
<body id="pageBody">
        ...
        <div class="span12">
          <div id="divLogo" class="pull-left">
            <a href="index.html" id="divSiteTitle">
              <img src="images/logo.png" alt="Universidad de Yahualica" style="width: 20rem" />
            </a>
          </div>
            ...
            <div class="navbar">
              ...
              <div class="nav-collapse collapse">
                <ul class="nav nav-pills ddmenu">
                  ...
                  <li><a href="publish-process.html">Proceso de Publicación</a></li>
        ...
        <div class="row-fluid">
          ...
          <div class="span3" id="footerArea2">
            ...
            <p style="display: flex; align-items: center; gap: 8px; margin: 0;">
              <svg xmlns="http://www.w3.org/2000/svg" width="1.7rem" height="auto" fill="currentColor"
              ...
              <a href="#" title="Facebook"
                style="text-decoration: none; color: #5e82b1; font-weight: 600; font-size: .80rem;">
                Facebook
              </a>
            </p>
          ...
          <div class="span3" id="footerArea3">
            ...
            <p style="display: flex; align-items: center; gap: 8px; margin: 0;">
              <svg xmlns="http://www.w3.org/2000/svg" width="1.7rem" height="1.1rem" fill="currentColor"
                viewBox="0 0 24 18" aria-hidden="true">
                <path
                  d="M2 2a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v0.5L12 9 2 2.5V2zm0 2.8V16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V4.8l-10 6.7L2 4.8z" />
              </svg>
              <a href="mailto:ejemplo@correo.com" title="Email"
                style="text-decoration: none; color: #5e82b1; font-weight: 600; font-size: .80rem;">
                Email
              </a>
            </p>
  ...
  <script
    type="text/javascript">$(window).load(function () { var options = { autoResize: true, container: $('#gridArea'), offset: 10 }; var handler = $('#tiles li'); handler.wookmark(options); $('#tiles li').each(function () { var imgm = 0; if ($(this).find('img').length > 0) imgm = parseInt($(this).find('img').not('p img').css('margin-bottom')); var newHeight = $(this).find('img').height() + imgm + $(this).find('div').height() + $(this).find('h4').height() + $(this).find('p').not('blockquote p').height() + $(this).find('iframe').height() + $(this).find('blockquote').height() + 5; if ($(this).find('iframe').height()) newHeight = newHeight + 15; $(this).css('height', newHeight + 'px'); }); handler.wookmark(options); handler.wookmark(options); });</script>
  <script src="scripts/yoxview/yox.js" type="text/javascript"></script>
  <script src="scripts/yoxview/jquery.yoxview-2.21.js" type="text/javascript"></script>
  <script
    type="text/javascript">$(document).ready(function () { $('.yoxview').yoxview({ autoHideInfo: false, renderInfoPin: false, backgroundColor: '#ffffff', backgroundOpacity: 0.8, infoBackColor: '#000000', infoBackOpacity: 1 }); $('.yoxview a img').hover(function () { $(this).animate({ opacity: 0.7 }, 300) }, function () { $(this).animate({ opacity: 1 }, 300) }); });</script>
